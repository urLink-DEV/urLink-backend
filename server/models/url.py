...
class Url(models.Model):
    ...
    title = models.CharField(max_length=500, default='제목을 가져오지 못했어요. 직접 제목을 입력해보세요.')
    description = models.CharField(max_length=500, default='본문을 가져오지 못했어요. 저장한 링크의 내용을 간단히 기록해보세요.')
